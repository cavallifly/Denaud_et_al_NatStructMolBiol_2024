...
zmax <- 100
scoreData <- list(
        LE_WT      = paste0("hic.hicScores_LE_WT_merge_dm6_YOVL.hicScores_LE_WT_merge_dm6_YOVL_chr2L_10_20Mb_score_k",k,"_kexp",kexp,"_step1Mb"),
        ...
        pupae_WT   = paste0("hic.hicScores_pupae_DWT_merge_dm6_BeS.hicScores_pupae_DWT_merge_dm6_BeS_chr2L_10_20Mb_score_k",k,"_kexp",kexp,"_step1Mb")
        )
...
for(annotated in c("FALSE"))
{
    ...
    png(file=paste0("scoreMapsk",k,"kexp",kexp,"_r",res,"bp_Fig2a_annot_",annotated,".png"),width=nc*slotSize,height=nr*slotSize)
	...
	data[is.na(data)] <- 0
	outMatrix <- paste0("scoreMapsk",k,"kexp",kexp,"_r",res,"bp_Fig2a_",set,".tsv")
    ...
    png(file=paste0("scoreMapsk",k,"kexp",kexp,"_r",res,"bp_Fig2a_annot_",annotated,"_toModify.png"),width=nc*slotSize,height=nr*slotSize)
    print(paste0("Plotting map between ",start,"-",end))
